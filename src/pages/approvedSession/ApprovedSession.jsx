                    ...
                    </div>
                    {
                        Data.map((e, i) => (
                            <div key={e.id} className='flex items-center justify-between md:pr-20 border-b'>
                                ...
                                {e.id == 1 && <div className='w-3/12 flex items-center'>
                                    <div><FaRegFilePdf className='text-blue-600'/></div>
                                    <a href={e.flyer} target='_blank' className='px-3 py-1  text-blue-600 hover:text-blue-800 hover:underline'>More Details-</a>
                                </div>}
                            </div>
                        ))
                    }
