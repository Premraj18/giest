                    ...
                    <div className="flex flex-wrap px-3 items-center justify-center w-full gap-14 font-bold text-lg">
                        ...
                        >
                            ...
                            <div className='flex gap-x-5 flex-col'>
                                <p className="text-lg ">10/07/2025 (Hard Deadline) </p>
                                {/* <p className="text-lg  text-lime-600">25/06/2025 </p> */}
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-lg  line-through">31/08/2025</p>
                            <p className="text-lg ">08/09/2025</p>
                        </div>
