...
const Contact = () => {
    return (
        <div className='pt-16 bg-slate-50'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 py-20 pt-10 gap-8 md:gap-0">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-blue-500 ">giestconf2025@gmail.com</p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-blue-500 ">Electrical Engineering Department</p>
                </div>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="mt-2 text-blue-500 ">+91-9006058445 / +91-8862950216</p>
                </div>
            </div>
        </div>
    )
